-- 관리자 계정으로 spring(비번 동일, 소문자) 계정 생성 및 권한 부여
-- create user spring identified by spring;
-- grant connect, resource to spring;
-- Spring 수업용계정_spring [초록색]
...
INSERT INTO MEMBER
VALUES ('admin', '1234', '관리자', 'admin@kh.or.kr', 'F', 30, '010-1111-2222', '서울시 강남구 역삼동', '20190101', '20190101', DEFAULT);

INSERT INTO MEMBER
VALUES ('user01', 'pass01', '차은우', 'user01@kh.or.kr', 'M', 25, '010-3333-4444', '서울시 마포구 공덕동', '20190201', '20190201', DEFAULT);

INSERT INTO MEMBER
VALUES ('user02', 'pass02', '주지훈', 'user02@kh.or.kr', 'F', 23, '010-5555-6666', '서울시 영등포구 양평동', '20190301', '20190301', DEFAULT);
...
INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '관리자 공지', 'admin', '공지서비스를 게시합니다. 많이 이용해 주세요', '20190201');

INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '공지서비스 오픈 환영', 'admin', '드디어 오픈되었군요. 많이 이용하겠습니다.', '20190201');

INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '공지서비스 이용 안내', 'admin', '공지서비스는 회원만 이용할 수 있습니다. 회원 가입하세요.', '20190201');
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'HTML로 화면을 만들어봅시다!', 'admin', 'HTML 태그를 이용해서 화면을 만들어볼까요? HTML 은 Front-end 의 틀을 담당합니다.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'CSS란?', 'user01', 'Front-end 의 스타일을 입혀주는 담당입니다. 예쁘게 꾸며주세요!', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'JavaScript 랑 Java 는 비슷한가요?', 'user02', '아니요. 인도랑 인도네시아를 생각하세요.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'jQuery', 'user02', '자바스크립트의 복잡한 구문을 짧고 간결하게 쓸 수 있게 도와주는 라이브러리에요~', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'JSP', 'user01', 'HTML 에 자바 코드를 삽입한 기술입니다. 주로 스크립틀릿을 이용해요.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '이거 꿀팁인데 EL을 이용하면 편리해요!', 'admin', '기존의 JSP 내장객체로부터 값을 뽑아올때 더 편리하다고 하네요^^', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'Spring!', 'user01', '자바로 웹사이트 구현을 더 수월하게 할 수 있도록 도와주는 프레임워크에요! 다만 규칙을 지켜야 합니다!', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
